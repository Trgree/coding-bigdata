...
public class JavaDecisionTreeClassificationExample {
    public static void main(String[] args) {
        ...
        DecisionTreeClassifier dt = new DecisionTreeClassifier()
        	...
        	//	.setMaxBins(maxBins)// 离散化"连续特征"的最大划分数// 默认32// 2---无穷大
                .setMaxDepth(5) // 树的最大深度 默认20 0---无穷大 m
                .setMinInfoGain(0.0) // 一个节点分裂的最小信息增益，值为[0,1] 默认0.0
                .setImpurity("gini") //默认 gini,还支持entropy（熵）
